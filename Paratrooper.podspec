...
Pod::Spec.new do |s|
  s.name             = 'Paratrooper'
  s.version          = '0.1.0'
  s.summary          = 'Paratrooper is a simple tool to change config easily.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
  Paratrooper is a simple tool to change config easily. It also provides a simple menu to allow change dynamically.
                       DESC
